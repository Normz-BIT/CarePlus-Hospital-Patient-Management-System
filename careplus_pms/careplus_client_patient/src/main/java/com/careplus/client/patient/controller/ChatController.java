...
public class ChatController {
    ...
    private void sendMessage() {
        ...
        if (res == null || !Boolean.TRUE.equals(res.getSuccess())) view.showMessage(res == null ? "No response from server." : res.getMessage());
    ...
    private void refresh() {
        ...
        if (res.getData() instanceof List<?>) for (Object msg : (List<Object>) res.getData()) view.appendMessage(String.valueOf(msg));
    }
}
